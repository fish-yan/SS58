...
public struct SS58 {
    public struct AddressFormat: RawRepresentable, Hashable, Codable, Sendable {
        ...
        /// Calamari Network, standard account (*25519).
        public static let calamari = Self(id: 78)
    ...
    public struct AddressCodec {
        ...
        public static func hash(data: Data) -> Data {
            let data = Self.prefix + data
            let blake = Blake2(digestLength: 64)
            blake.update(data.bytes)
            return Data(blake.final())
        }
